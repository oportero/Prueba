...
public interface CuentaRepository extends JpaRepository<Cuenta, Long> {
    ...
    @Query(value = "select mo.fechaMovimiento, p.nombre, cu.numeroCuenta, cu.tipoCuenta, mo.saldo,cu.estado , mo.tipoMovimiento, mo.valor\n"
            ...
            + "and FORMAT(fechaMovimiento, 'yyyy-MM-dd') >=  :fechaInicio \n"
            + "and FORMAT(fechaMovimiento, 'yyyy-MM-dd') <= :fechaFin \n"
            + "order by fechaMovimiento asc", nativeQuery = true)
